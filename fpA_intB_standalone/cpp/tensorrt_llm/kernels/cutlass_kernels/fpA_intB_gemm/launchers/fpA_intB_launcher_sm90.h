...
// Standalone build: include definitions so this launcher can be instantiated without relying on TRT-LLM's
// generated-kernel compilation units.
#include "fpA_intB_launcher_sm90.inl"
